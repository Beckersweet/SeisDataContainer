...
spmd
    ...
    if distribute
        SeisDataContainer.io.memmap.serial.DataWrite(dirname,filename,lx,file_precision);
    else
        SeisDataContainer.io.acquireIOlock(dirname);
        SeisDataContainer.io.memmap.serial.DataWriteLeftChunk(dirname,filename,lx,...
