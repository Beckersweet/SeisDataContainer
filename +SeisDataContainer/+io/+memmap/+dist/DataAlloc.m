...
cdirnames = SeisDataContainer.utils.Cell2Composite(dirnames);
cdimensions = SeisDataContainer.utils.Cell2Composite(dimensions);
...
spmd
    ...
    SeisDataContainer.io.allocFile(filename,prod(cdimensions),bytesize);
end
