...
SeisDataContainer.io.memmap.serial.FileAlloc(dirnameOut,headerIn);
header       = headerIn;
header.size  = [1 prod(headerIn.size)];
SeisDataContainer.io.memmap.serial.HeaderWrite(dirnameOut,header);
...
SeisDataContainer.io.memmap.serial.HeaderWrite(dirnameOut,headerIn);
end
