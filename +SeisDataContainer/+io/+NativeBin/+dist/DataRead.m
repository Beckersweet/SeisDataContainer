...
spmd
    ...
    % read data
    if distributed
        lx = SeisDataContainer.io.NativeBin.serial.DataRead(dirname,filename,csize,file_precision,x_precision);
    else
        lx = SeisDataContainer.io.NativeBin.serial.DataReadLeftChunk(dirname,filename,...
